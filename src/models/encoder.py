...
class EncoderDecoderRNN(nn.Module):
    ...
    def __init__(self, w2v_weights, decoder_embedding_size, hidden_dim, tagset_size, drop_rate, bidirectional=False,
        ...
        self.gru_decoder = nn.GRU(self.decoder_embedding_size, self.hidden_dim, batch_first=True, dropout=drop_rate)
